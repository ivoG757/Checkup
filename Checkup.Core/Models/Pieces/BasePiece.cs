...
namespace Checkup.Core.Models.Pieces
{
    public abstract class BasePiece
    {
        ...
        internal abstract List<(int x, int y)> GetValidMoves(Board board, int currentX, int currentY);
        ...
        internal abstract List<(int x, int y)> GetAttackedSquares(Board board, int currentX, int currentY);
        ...
        internal List<(int x, int y)> GetSlidingAttacks(Board board, int x, int y, (int dx, int dy)[] directions)
        {
        ...
        internal List<(int x, int y)> GetSlidingMoves(Board board, int x, int y, (int dx, int dy)[] directions)
        {
            var result = new List<(int, int)>();
